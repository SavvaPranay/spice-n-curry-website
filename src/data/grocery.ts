...
export const groceryItems: GroceryItem[] = [
  // Spices & Masalas
  { id: 'turmeric', name: 'Turmeric Powder (Haldi)', description: 'Premium quality turmeric for cooking and health', category: 'spices', image: '/images/grocery/turmeric-powder.jpg', inStock: true },
  { id: 'cumin', name: 'Cumin Seeds (Jeera)', description: 'Aromatic cumin seeds for tempering', category: 'spices', image: '/images/grocery/cumin-seeds.jpg', inStock: true },
  { id: 'coriander', name: 'Coriander Powder (Dhania)', description: 'Freshly ground coriander powder', category: 'spices', image: '/images/grocery/garam-masala.jpg', inStock: true },
  ...
  { id: 'chili-powder', name: 'Red Chili Powder', description: 'Hot and flavorful red chili powder', category: 'spices', image: '/images/grocery/red-chili-powder.jpg', inStock: true },
  ...
  { id: 'mustard-seeds', name: 'Mustard Seeds (Rai)', description: 'Small black mustard seeds for tempering', category: 'spices', image: '/images/grocery/mustard-seeds.jpg', inStock: true },
  { id: 'cloves', name: 'Cloves (Laung)', description: 'Aromatic whole cloves', category: 'spices', image: '/images/grocery/cloves.jpg', inStock: true },
  { id: 'cinnamon', name: 'Cinnamon Sticks (Dalchini)', description: 'Whole cinnamon sticks for flavoring', category: 'spices', image: '/images/grocery/cinnamon-sticks.jpg', inStock: true },
  { id: 'black-pepper', name: 'Black Peppercorns (Kali Mirch)', description: 'Whole black peppercorns', category: 'spices', image: '/images/grocery/black-pepper.jpg', inStock: true },
  ...
  { id: 'toor-dal', name: 'Toor Dal (Arhar)', description: 'Split pigeon peas for dal dishes', category: 'lentils', image: '/images/grocery/moong-dal.jpg', inStock: true },
  { id: 'chana-dal', name: 'Chana Dal', description: 'Split chickpeas for curries and snacks', category: 'lentils', image: '/images/grocery/moong-dal.jpg', inStock: true },
  ...
  // Snacks & Sweets
  { id: 'bhujia', name: 'Bikaneri Bhujia', description: 'Crispy spiced gram flour noodles', category: 'snacks', image: '/images/menu/bhujia.jpg', inStock: true },
  { id: 'mixture', name: 'Mumbai Mixture', description: 'Savory mix of fried snacks', category: 'snacks', image: '/images/menu/mixture.jpg', inStock: true },
  { id: 'mathri', name: 'Mathri', description: 'Flaky, spiced crackers', category: 'snacks', image: '/images/menu/mathri.jpg', inStock: true },
  { id: 'gulab-jamun-mix', name: 'Gulab Jamun Mix', description: 'Ready-to-make gulab jamun', category: 'snacks', image: '/images/menu/gulab-jamun-mix.jpg', inStock: true },
  { id: 'soan-papdi', name: 'Soan Papdi', description: 'Flaky sweet made with gram flour', category: 'snacks', image: '/images/menu/soan-papdi.jpg', inStock: true },
  ...
  // Beverages
  { id: 'chai-masala', name: 'Chai Masala', description: 'Spice blend for perfect masala chai', category: 'beverages', image: '/images/menu/chai-masala.jpg', inStock: true },
  ...
  { id: 'rooh-afza', name: 'Rooh Afza', description: 'Traditional rose-flavored drink', category: 'beverages', image: '/images/menu/rooh-afza.jpg', inStock: true },
  ...
  { id: 'mint-chutney', name: 'Mint Chutney', description: 'Fresh green mint chutney', category: 'pickles', image: '/images/grocery/mint.jpg', inStock: true },
];
